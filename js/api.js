 ...
 * الدستور المطبق: حماية JWT، الجلسة الأحادية، التكامل السحابي مع R2، والتحصين ضد الاستدعاء المزدوج (Null-Safe).
 */

// [الإصلاح الأمني]: درع مضاد للانهيار (Anti-Crash). نتحقق مما إذا كان المحرك موجوداً مسبقاً
if (typeof window.API === 'undefined') {
    
    // تم وضع الرابط الفعلي الخاص بك هنا بنجاح
    ...
    const API_CORE = {
        ...
        clearSession: () => {
            ...
            localStorage.removeItem('moakkil_biometric_id');
        ...
        getSecureUrl(filePath) {
            if (!filePath) return '/assets/img/placeholder.png'; 
