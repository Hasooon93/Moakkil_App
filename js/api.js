...
const API = {
    ...
    // 10. محرك الرفع إلى Google Drive (عبر Google Apps Script)
            ...
            reader.onload = async () => {
                try {
                    ...
                    const payload = {
                        ...
                        mimeType: file.type,
                        fileData: base64Data,
                        caseNumber: caseInternalId // لإنشاء مجلد برقم القضية
                    };
                    
                    // إرسال البيانات كتلة نصية (Text) لتجنب مشاكل CORS مع Google
                    ...
                    if(result && result.url) {
                        ...
                        reject(new Error("فشل الرفع، لم يتم إرجاع رابط من جوجل"));
                    }
                } catch (err) {
                    reject(err);
                }
